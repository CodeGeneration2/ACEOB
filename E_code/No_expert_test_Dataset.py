...
class No_expert_Test_Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, Data_set_root_path='ECG'):
        ...
        self.Initialize(f'{Data_set_root_path}/test')
    ...
    def Initialize(self, Data_set_root_path):
        ...
        for certain_entry in tqdm(range(len(List_of_training_sets))):
            ...
            with open(f'{Data_set_root_path}/{certain_entry}/Question.txt', 'r', encoding='UTF-8') as f:
            ...
            for certain_code in List_of_slow_code_sets:
                ...
                certain_data_tuple = (Total_problem_text, slow_code, The_tag_code, Input_and_output_case_paths, Data_original_path)
