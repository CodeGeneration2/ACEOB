...
# #####################################################################################################################
# ###############################################################################################################
def run_test(prob_path: str = None,
        ...
        for index, inputs in enumerate(in_outs["inputs"]):
            ...
            if which_type == CODE_TYPE.call_based:  # Call-based
                ...
                try:
                    ...
                    # print(f"in_outs['outputs'][index] = {in_outs['outputs'][index]}")
...
def custom_compare_(output, ground_truth):
    ...
    if isinstance(output, list):
        ...
        if stripped_string_compare(output_1, ground_truth):
            return True
        elif output_1.strip().lower() == 'yes'.lower() and ground_truth.strip().lower() == 'yes'.lower():
            return True
        elif output_1.strip().lower() == 'no'.lower() and ground_truth.strip().lower() == 'no'.lower():
            return True
