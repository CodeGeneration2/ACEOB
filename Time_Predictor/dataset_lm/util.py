...
def _T5_apply_mask(sample, mask, tokenizer, hide_sentinels=False):
    ...
    (Bowman et al., 2015), we design an objective that randomly Total_Data_List and then drops out 15% of tokens in the input
    ...
    # Tokenized_GPT.vocab_size does NOT include those.
